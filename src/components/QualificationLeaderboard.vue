    ...
    <div class="container mx-auto px-4">
      ...
      <template v-else>
        ...
        <header class="text-center mb-16">
          <h1 class="text-4xl font-bold text-gray-900 mb-2">Platzierung der Qualifikationsrunde</h1>
          <p class="text-lg text-gray-600 -mb-4">Stand nach der {{ roundDescription }}</p>
        </header>
